...
export default function Navbar() {
  ...
  return (
    <div className="fixed w-full p-3 flex justify-center items-center z-50">
      <div
        className={`cShadow w-full ${openSubMenu ? "h-[530px] lg:h-[75px]" : "h-[65px] lg:h-[75px]"} transition-all duration-300 rounded-r-3xl rounded-tl-3xl bg-azulClaroBooster overflow-hidden flex flex-col lg:flex-row lg:items-center lg:justify-between`}
      >
