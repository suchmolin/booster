...
export default function Navbar() {
  ...
  return (
    <div className="fixed w-full p-3 flex justify-center items-center z-50">
      <div
        className={`cShadow w-full ${openSubMenu ? "h-[500px] lg:h-[90px]" : "h-[90px]"} transition-all duration-300 rounded-r-3xl rounded-tl-3xl bg-[#DBF3F9] overflow-hidden flex flex-col lg:flex-row lg:items-center lg:justify-between`}
      >
        <div className="flex justify-between items-center min-h-[90px] lg:h-[90px] w-full">
